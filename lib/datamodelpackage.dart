...
import 'package:datamodelpackage/ContactsDataModel.dart';
import 'package:datamodelpackage/InventoryItemDataModel.dart';
import 'package:datamodelpackage/LedgerMasterDataModel.dart';
...
class GeneralVoucherDataModel extends Equatable {
  ...
  final ContactsDataModelOLD? Contact;
  final String? LPO;
  ...
  factory GeneralVoucherDataModel.fromMap(Map<String, dynamic> map) {
    return GeneralVoucherDataModel(
      ...
      Contact: map['Contact'] != null
          ? ContactsDataModelOLD.fromMap(map['Contact'])
          : null,
      LPO: map['LPO'],
