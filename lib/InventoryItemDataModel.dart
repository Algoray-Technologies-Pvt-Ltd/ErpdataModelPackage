...
final String column_KOT_Prfinaler = "KOT_Prfinter";
...
//Transaction vals
  ...
  List<GodownDataModel>? godownList;
  ...
  factory InventoryItemDataModel.fromMap(Map<String, dynamic> map) {
    return InventoryItemDataModel(
      ...
      godownList: List<GodownDataModel>.from(
          map['godownList']?.map((x) => GodownDataModel.fromMap(x))),
